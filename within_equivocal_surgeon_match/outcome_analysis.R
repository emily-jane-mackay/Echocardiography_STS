...
# eFigure 7 and Section 6.2.4 in eAppendix
################################################################################
library(ggplot2)
...
complete_TEE_info = which(control_all$TEE_missing == 0)
treated_all = treated_all[complete_TEE_info,]
control_all = control_all[complete_TEE_info,]
