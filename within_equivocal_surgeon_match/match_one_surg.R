...
match_one_surgeon <- function(ID){
  ...
  # Rename covariates, e.g., sex_e = male/female to sex_male = 1/0
  ...
  match_mat = rcbsubset(dist.matrix)
  ...
  # Save the matched treated and control
...
# A trycatch version of the function. We catch the following two errors
# 1. the treated and control groups have no overlap;
# 2. surgeon's preference is 1 or 0.
