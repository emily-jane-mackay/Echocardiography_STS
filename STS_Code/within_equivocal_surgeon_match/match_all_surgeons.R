...
################################################################################
# For each ID of an equivocal surgeon, do a within-surgeon statistical matching 
# if such a match is feasible. The matching result for each surgeon is saved to
# the dir: <directory> 

all_files = list.files('<data file>')
K = length(all_files) # number of surgeons to be matched: 595
for (i in 1:K){
...
# Write matched data to .csv files
